...
export default ListFormRoute.extend({
  /**
    ...
    @type String
    @default 'Sec_SubjectL'
  */
  modelProjection: 'Sec_SubjectL',
  ...
  */
  ...
  /**
    ...
    @default {}
  */
  developerUserSettings: { ICSSoftSTORMNETSecurityViewL: {} },
  /**
  ...
  objectListViewLimitPredicate: function(options) {
    ...
    if (methodOptions.modelName === this.get('modelName') &&
      ...
      let limitFunction = new Query.SimplePredicate('isView', Query.FilterOperator.Eq, true);
