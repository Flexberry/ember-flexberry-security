...
export default ListFormRoute.extend({
  ...
  */
  ...
  /**
    ...
    @default {}
  */
  developerUserSettings: { ICSSoftSTORMNETSecurityClassL: {} },
  /**
  ...
  objectListViewLimitPredicate: function(options) {
    ...
    if (methodOptions.modelName === this.get('modelName') &&
      ...
      let limitFunction = new Query.SimplePredicate('isClass', Query.FilterOperator.Eq, true);
