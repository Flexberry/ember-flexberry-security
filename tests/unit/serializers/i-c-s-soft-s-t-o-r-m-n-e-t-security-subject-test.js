...
moduleForModel('i-c-s-soft-s-t-o-r-m-n-e-t-security-subject', 'Unit | Serializer | i-c-s-soft-s-t-o-r-m-n-e-t-security-subject', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-c-s-soft-s-t-o-r-m-n-e-t-security-subject',
    'transform:file',
    'transform:decimal',
