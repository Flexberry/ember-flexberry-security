...
moduleForModel('i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-audit-session', 'Unit | Serializer | i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-audit-session', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-c-s-soft-s-t-o-r-m-n-e-t-business-audit-objects-audit-session',
    'transform:file',
    'transform:decimal',
