...
moduleForModel('i-c-s-soft-s-t-o-r-m-n-e-t-security-impersonalization', 'Unit | Serializer | i-c-s-soft-s-t-o-r-m-n-e-t-security-impersonalization', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-c-s-soft-s-t-o-r-m-n-e-t-security-impersonalization',
    'transform:file',
    'transform:decimal',
