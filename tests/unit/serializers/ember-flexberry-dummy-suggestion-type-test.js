...
moduleForModel('ember-flexberry-dummy-suggestion-type', 'Unit | Serializer | ember-flexberry-dummy-suggestion-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-suggestion-type',
    'transform:file',
    'transform:decimal',
