...
moduleForModel('i-c-s-soft-s-t-o-r-m-n-e-t-security-link-role', 'Unit | Serializer | i-c-s-soft-s-t-o-r-m-n-e-t-security-link-role', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-c-s-soft-s-t-o-r-m-n-e-t-security-link-role',
    'transform:file',
    'transform:decimal',
