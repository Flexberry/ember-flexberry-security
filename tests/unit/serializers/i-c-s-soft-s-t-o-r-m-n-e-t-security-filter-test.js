...
moduleForModel('i-c-s-soft-s-t-o-r-m-n-e-t-security-filter', 'Unit | Serializer | i-c-s-soft-s-t-o-r-m-n-e-t-security-filter', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-c-s-soft-s-t-o-r-m-n-e-t-security-filter',
    'transform:file',
    'transform:decimal',
