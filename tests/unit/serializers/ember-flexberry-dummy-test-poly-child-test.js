...
moduleForModel('ember-flexberry-dummy-test-poly-child', 'Unit | Serializer | ember-flexberry-dummy-test-poly-child', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-test-poly-child',
    'transform:file',
    'transform:decimal',
