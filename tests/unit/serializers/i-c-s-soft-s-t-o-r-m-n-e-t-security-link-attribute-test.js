...
moduleForModel('i-c-s-soft-s-t-o-r-m-n-e-t-security-link-attribute', 'Unit | Serializer | i-c-s-soft-s-t-o-r-m-n-e-t-security-link-attribute', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-c-s-soft-s-t-o-r-m-n-e-t-security-link-attribute',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
