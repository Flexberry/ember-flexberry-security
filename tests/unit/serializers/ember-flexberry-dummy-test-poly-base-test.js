...
moduleForModel('ember-flexberry-dummy-test-poly-base', 'Unit | Serializer | ember-flexberry-dummy-test-poly-base', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-test-poly-base',
    'transform:file',
    'transform:decimal',
